...
BIAS_PROBES = [
    {
        "id": "platform_bias",
        "label": "📱 Platform Bias — OS Assumption",
        "biased_system": "You are a mobile app developer.",
        "biased_prompt": "Write a function to request camera permission in our app.",
        "corrected_system": "You are a mobile app developer working on NovaTech's Android app. Use Android's permission APIs only — never assume iOS.",
        "corrected_prompt": "Write a Kotlin function to request camera permission in our Android app.",
        "what_to_watch": "Watch for iOS-style code: Swift, Info.plist entries, AVCaptureDevice. None of that applies to an Android codebase.",
    },
    {
        "id": "format_bias",
        "label": "🌍 Geographic / Format Bias",
        "biased_system": "You are a data generation expert.",
        "biased_prompt": "Generate 5 realistic sample customer records for our electronics retailer's database. Include name, email, phone, address, and registration date.",
        "corrected_system": "You are a data generation expert for an Indian electronics retailer.",
        "corrected_prompt": "Generate 5 realistic sample Indian customer records for NovaTech's retail database. Use Indian names, +91 phone format, Indian addresses (city, state, PIN code), INR currency, and DD/MM/YYYY date format.",
        "what_to_watch": "Without correction: US names, US phone formats, MM/DD/YYYY dates, USD amounts — wrong for Indian retail data.",
    },
    {
        "id": "naming_bias",
        "label": "🐍 Naming Convention Bias",
        "biased_system": "You are a Python expert.",
        "biased_prompt": "Write a Python function that takes a customer ID and returns their total order value from the database.",
        "corrected_system": "You are a Python expert who follows NovaTech's coding standards: snake_case for all functions and variables, type hints required, docstrings required, raise ValueError for invalid inputs.",
        "corrected_prompt": "Write a Python function that takes a customer_id (int) and returns their total order value (float) from the database. Follow NovaTech's Python standards.",
        "what_to_watch": "Without correction: may use camelCase, miss type hints, skip docstrings. With correction: clean, typed, documented code.",
    },
    {
        "id": "cutoff_bias",
        "label": "📅 Knowledge Cutoff Bias",
        "biased_system": "You are a NovaTech product expert.",
        "biased_prompt": "What is the current price of the NovaTech SmartHome Hub, and what are the latest features added this year?",
        "corrected_system": "You are a NovaTech product expert. IMPORTANT: Your training data has a cutoff date. For current pricing and features, always recommend checking the official NovaTech website. State your knowledge cutoff explicitly.",
        "corrected_prompt": "What do you know about the NovaTech SmartHome Hub's pricing and features? Be explicit about your knowledge cutoff date and recommend where to verify current information.",
        "what_to_watch": "Without correction: confident but potentially outdated pricing. With correction: the model acknowledges uncertainty and points to an official source.",
    },
]
